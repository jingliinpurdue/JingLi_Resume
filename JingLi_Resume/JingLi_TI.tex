...
MSEE 357,   & \textbf{Phone:} (765)476-3344\\
 465 Northwestern Avenue,      & \textbf{Email:} \email{jingli@purdue.edu} \\
 West Lafayette, IN  47907 &  \textbf{Homepage:} \href{https://engineering.purdue.edu/people/jing.li.21}{engineering.purdue.edu/people/jing.li.21}
\end{tabular}
...
%\vspace{-.1in}
\section{ Skills}
\textbf{Programming:} Python, C\texttt{++}, Java, C, Matlab, Keras, Tensorflow\\
%\textbf{Language :} Chinese, English, Japanese\\
\textbf{Research Area :} Computer Vision, Deep Learning, Image Processing Algorithms, Computational Imaging, Model Based Image Reconstruction
...
\textbf{Volunteer} in Purdue WInterization 2018  \hfill Nov 2018 \\
\textbf{Volunteer} in Purdue WInterization 2017  \hfill Nov 2017 \\
...
%\vspace{-.1275in}
\begin{bibsection}
 	\item Shuhui Jiang, Xueming Qian, Ke Lan, {\bf Jing Li} $\&$  Fan Li, “Social Media User Multimedia Data Management”. NO. ZL 2001 1 0364974.4
 	\item {\bf Jing Li},$\&$  Xueming Qian, “Hierarchical fast image global positioning system (GPS) position estimation method”. CN103324677B
